...
{
    public class CarouselViewPagePrismViewModel : ViewModelBase
    {
        public ObservableCollection<Monkey> Monkeys { get; set; } = new ObservableCollection<Monkey>();

        public CarouselViewPagePrismViewModel(INavigationService navigationService)
            : base(navigationService)
        {
            Title = "CarouselView (Prism ver.)";
